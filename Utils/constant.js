...
// Payment window limit (minutes) for accepting successful payments
const PAYMENT_TIME_LIMIT_MINUTES = parseInt(process.env.PAYMENT_TIME_LIMIT_MINUTES || '30', 10);
