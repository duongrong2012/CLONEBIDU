...
class AuthAdminController {
    ...
    async login(req, res, next) {
        try {
            ...
            return res.json(
                response.success('Admin login successful', result.admin)
            );
        } catch (error) {
            next(error);
        }
    ...
    async getProfile(req, res, next) {
        try {
            ...
            return res.json(
                response.success('Admin profile retrieved successfully', admin)
            );
        } catch (error) {
            next(error);
        }
    ...
    async updateProfile(req, res, next) {
        try {
            ...
            return res.json(
                response.success('Admin profile updated successfully', admin)
            );
        } catch (error) {
            next(error);
        }
    ...
    async changePassword(req, res, next) {
        try {
            ...
            const result = await authAdminService.changePassword(
                req.user.id,
                oldPassword,
                newPassword
            );
